...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("My Swing GUI with GIF");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(400, 300);

            guiClass panel = new guiClass("C:\\Users\\beege\\OneDrive\\Desktop\\Sprite-0003.gif");
            frame.add(panel);
            frame.setVisible(true);
        });

        // Run the heavy task separately, so it doesn't block the GUI

            // Your complex, slow code here
